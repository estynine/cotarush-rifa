...
Para producao na Vercel, use o nome de projeto `cotarushrifa` e configure o dominio:

```bash
NEXT_PUBLIC_APP_URL=https://cotarushrifa.vercel.app
FRONTEND_ORIGIN=https://cotarushrifa.vercel.app
MERCADO_PAGO_WEBHOOK_URL=https://cotarushrifa.vercel.app/api/webhooks/mercadopago
```
